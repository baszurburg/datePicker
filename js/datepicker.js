/*! DatePicker v6 MIT/GPL2 @freqdec - v6.01 updateOnly boolean for add & setDate functions @baszurburg*/
var datePickerController = (function datePickerController() {
    ...
    function stopEvent(e) {
        ...
        if (typeof e.returnValuee !== "undefined") {
            e.returnValue = false;
        }
        return false;
    };
    ...
    function datePicker(options) {
        ...
        this.updateTable = function(noCallback, updateOnly) {
        ...
        this.destroy = function() {
            ...
            if (o.lessJS58 && !o.staticPos && !o.isIE7) {
                try {
    ...
    datePicker.prototype.setDisabledDates = function(dateObj, updateOnly) {
        this.filterDateList(dateObj, true, updateOnly);
    };
    datePicker.prototype.setEnabledDates = function(dateObj, updateOnly) {
        this.filterDateList(dateObj, false, updateOnly);
    };
    datePicker.prototype.addDisabledDates = function(dateObj, updateOnly) {
        this.addDatesToList(dateObj, true, updateOnly);
    };
    datePicker.prototype.addEnabledDates = function(dateObj, updateOnly) {
        this.addDatesToList(dateObj, false, updateOnly);
    };
    datePicker.prototype.filterDateList = function(dateObj, type, updateOnly) {
        var tmpDates = [];
        ...
        this.addDatesToList(dateObj, type, updateOnly);
    };
    datePicker.prototype.addDatesToList = function(dateObj, areDisabled, updateOnly) {
		var startD;
        ...
        if(!this.inUpdate) {
            if (updateOnly) {
				this.updateTable(true, updateOnly);
			} else {
				this.setDateFromInput();
			}
        };
    };
    datePicker.prototype.setSelectedDate = function(yyyymmdd, updateOnly) {
        ...
        if (updateOnly) {
	        this.returnFormattedDate(false, updateOnly);
        } else {
    ...
    datePicker.prototype.returnFormattedDate = function(noFocus, updateOnly) {
    ...
    return {
        ...
        setSelectedDate:        function(inpID, yyyymmdd, updateOnly) { if(!inpID || !(inpID in datePickers)) { return false; }; datePickers[inpID].setSelectedDate(dateToYYYYMMDD(yyyymmdd), updateOnly); },
        // Is the date valid for selection i.e. not outside ranges etc
        dateValidForSelection:  function(inpID, dt) { if(!inpID || !(inpID in datePickers)) return false; return datePickers[inpID].canDateBeSelected(dt); },
        // Add disabled and enabled dates
        addDisabledDates:       function(inpID, dts, updateOnly) { if(!inpID || !(inpID in datePickers)) return false; datePickers[inpID].addDisabledDates(dts, updateOnly); },
        setDisabledDates:       function(inpID, dts, updateOnly) { if(!inpID || !(inpID in datePickers)) return false; datePickers[inpID].setDisabledDates(dts, updateOnly); },
        addEnabledDates:        function(inpID, dts, updateOnly) { if(!inpID || !(inpID in datePickers)) return false; datePickers[inpID].addEnabledDates(dts, updateOnly); },
        setEnabledDates:        function(inpID, dts, updateOnly) { if(!inpID || !(inpID in datePickers)) return false; datePickers[inpID].setEnabledDates(dts, updateOnly); },
