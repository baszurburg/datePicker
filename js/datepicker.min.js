...
/*@cc_on
                    ...
                    /*@end@*/
th.appendChild(but);}}function createSingleThAndButton(details){var th=createTH(details);var but=document.createElement("span");but.className=details.className;but.id=o.id+details.id;but.appendChild(document.createTextNode(details.text||o.nbsp));but.title=details.title||"";
/*@cc_on
                 /*@if(@_win32)
                 th.unselectable = but.unselectable = "on";
                 /*@end@*/
